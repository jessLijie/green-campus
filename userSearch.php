    ...
    <div class="d-flex flex-nowrap" style="margin: 2%">
            ...
            function newsfees($result)
            {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo '<a href="post.php?id=' . $row['id'] . '" style="text-decoration:none">';
                    echo '<div class="card" style="width: 18rem;">';
                    echo '<img src="image/' . $row['image_url'] . '" class="card-img-top" style="width:286px; height:180px; alt="..."/>';
            ...
            <div class="tab-content" id="myTabContent" style="padding-top: 1%; padding-bottom: 1%;">
                ...
                <div class="tab-pane fade" id="campusNews-tab-pane" role="tabpanel" aria-labelledby="campusNews-tab"
                    tabindex="0"><?php $result2 = mysqli_query($con, "SELECT * FROM newsfeed WHERE title LIKE '$query' AND category = 'Campus News'");
                    newsfees($result2); ?>
                </div>
                <div class="tab-pane fade" id="events-tab-pane" role="tabpanel" aria-labelledby="events-tab"
                    tabindex="0">
                    <?php $result3 = mysqli_query($con, "SELECT * FROM newsfeed WHERE title LIKE '$query' AND category = 'Events'");
                    newsfees($result3); ?>
                </div>
                <div class="tab-pane fade" id="achievements-tab-pane" role="tabpanel" aria-labelledby="achievements-tab"
                    tabindex="0"><?php $result4 = mysqli_query($con, "SELECT * FROM newsfeed WHERE title LIKE '$query' AND category = 'Achievements'");
                    newsfees($result4); ?>
                </div>
                <div class="tab-pane fade" id="facilities-tab-pane" role="tabpanel" aria-labelledby="facilities-tab"
                    tabindex="0"><?php $result5 = mysqli_query($con, "SELECT * FROM newsfeed WHERE title LIKE '$query' AND category = 'Facilities'");
                    newsfees($result5); ?>
                </div>
            </div>
        </div>
